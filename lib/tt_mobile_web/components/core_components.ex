defmodule TtMobileWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TtMobileWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TtMobileWeb.Gettext, "errors", msg, opts)
    end
  end
